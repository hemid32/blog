...
class ContactRef(models.Model):
    me_ref = models.ForeignKey(Me, related_name="contact_refs" , on_delete= False )
...
class Education(models.Model):
    me_ref = models.ForeignKey(Me, related_name="educations", on_delete= False )
    title = models.CharField(max_length=200)
...
class Language(models.Model):
    me_ref = models.ForeignKey(Me, related_name="languages", on_delete= False )
    name = models.CharField(max_length=200)
...
class Interest(models.Model):
    me_ref = models.ForeignKey(Me, related_name="interests", on_delete= False)
    name = models.CharField(max_length=200)


class Skills(models.Model):
    me_ref = models.ForeignKey(Me, related_name="skills", on_delete= False )
    name = models.CharField(max_length=200)
    value = models.IntegerField()  # 0 and 100


class Experience(models.Model):
    me_ref = models.ForeignKey(Me, related_name="experiences", on_delete= False )
    title = models.CharField(max_length=200)
    where = models.CharField(max_length=200, blank=True)
    link = models.CharField(max_length=200, blank=True)
    time_frame = models.CharField(max_length=200, blank=True)
...
class ExtraSection(models.Model):
    me_ref = models.ForeignKey(Me, related_name="extra_sections", on_delete= False )
    title = models.CharField(max_length=200)
